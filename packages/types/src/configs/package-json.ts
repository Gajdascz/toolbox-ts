...
export interface PackageJson {
  ...
  devEngines?: Partial<
    Record<
      ...
      Partial<PackageDevEngineEntry> | Partial<PackageDevEngineEntry>[]
    >
  >;
  /**
   ...
   * ```
   */
  exports?: Record<string, { [key: string]: string } & { import: string }>;
  /**
   ...
   * @see {@link https://docs.npmjs.com/cli/v11/configuring-npm/package-json#funding}
   */
  funding?: (PackageFundingObj | string)[] | PackageFundingObj | string;
  /**
