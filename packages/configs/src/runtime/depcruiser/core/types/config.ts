...
> {
  ...
  doNotFollow?: { dependencyTypes?: DependencyType[]; path?: string | string[] };
  exclude?: string | string[];
}
export interface InputDepCruiserConfig extends Omit<IConfiguration, 'forbidden' | 'options'> {
  forbidden?: { cfg?: Partial<NativeForbiddenRulesConfig>; extended?: IForbiddenRuleType[] };
...
export type InputConfig = InputDepCruiserConfig;
export type ProcessedConfig = IConfiguration;
