import type { IForbiddenRuleType, IRegularForbiddenRuleType } from 'dependency-cruiser';
...
export type NativeForbiddenRulesConfig = {
  [K in NativeForbiddenRuleName]?: boolean | Parameters<ForbiddenRuleFactory<K>['generate']>[0];
};
export type RuleFactoryCfg<N extends string> = Omit<Partial<ForbiddenRule<N>>, 'comment' | 'name'>;
