...
export default {
  forbidden: [
    ...
    },
    {
      ...
      from: {
        pathNot: ['\\.(?:spec|test|bench|test-d)[.](?:js|mjs|cjs|jsx|ts|mts|cts|tsx)$', 'fixtures']
      },
...

    {
      ...
      severity: 'error',
      from: {},
      to: { path: '[.](?:spec|test|test-d)[.](?:js|mjs|cjs|jsx|ts|mts|cts|tsx)$' }
    },
    {
      name: 'not-to-dev-dep',
      severity: 'error',
...
// generated: dependency-cruiser@16.10.4 on 2025-12-06T23:36:05.372Z
