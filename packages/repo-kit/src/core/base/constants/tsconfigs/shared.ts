...
import { TEST_FILE_SUFFIXES } from '../exts.js';
import { ALWAYS_IGNORE, matchAllSuffixed } from '../patterns.js';
import { DOMAINS as REPO_DOMAINS } from '../repo.js';
...
export const BASE_META: TsConfig.Meta<TsConfigDomain<0>> = {
  $schema: SCHEMA,
...
export const REFERENCE_META: TsConfig.Meta<TsConfigDomain<1>> = {
  $schema: SCHEMA,
  filename: TSCONFIG,
  name: DOMAINS[1],
  description:
...
export const BUILD_META: TsConfig.Meta<TsConfigDomain<2>> = {
  $schema: SCHEMA,
...
export const DEV_META: TsConfig.Meta<TsConfigDomain<3>> = {
  $schema: SCHEMA,
...
export const TEST_META: TsConfig.Meta<TsConfigDomain<4>> = {
  $schema: SCHEMA,
...
export const SHARED_DEFAULT_BUILD_COMPILER_OPTIONS: TsConfig.CompilerOptions = {
  declaration: true,
  declarationMap: true,
  sourceMap: true,
