...
import { createForbiddenRule } from './forbidden-rule-factory.ts';
...
describe('forbiddenRuleFactory', () => {
  describe('factory creation', () => {
    it('should createForbiddenRule a factory with META properties', () => {
      const _factory = createForbiddenRule(
        'test-rule',
    ...
    it('should createForbiddenRule defaults with default values when no config provided', () => {
    ...
    it('should createForbiddenRule defaults with custom severity', () => {
      const _factory = createForbiddenRule('test-rule', 'Test description', {
        severity: 'warn'
      });
    ...
    it('should createForbiddenRule defaults with custom from configuration', () => {
    ...
    it('should createForbiddenRule defaults with custom to configuration', () => {
    ...
    it('should createForbiddenRule defaults with all custom configurations', () => {
  ...
  describe('type safety', () => {
    it('should preserve generic type parameter for rule name', () => {
      const _factory = createForbiddenRule('specific-rule-name', 'Description');
      const rule = _factory.generate();
    ...
    it('should work with different rule names', () => {
      const factory1 = createForbiddenRule(
        'no-circular',
        'Prevent circular deps'
      );
      const factory2 = createForbiddenRule('no-dev-deps', 'Prevent dev deps');
